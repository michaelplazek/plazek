...
- **Server Side Rendering (SSR)** - renders the HTML at runtime _on the server_
- **Traditional Single Page Applications (SPA)** - renders the HTML at runtime _on the client_
...
### Traditional Single Page Applications - _4 / 5_
...
There _are_ cases with complicated apps where the server rendering time incurs a cost that is comparable to client-side rendering times.
As usual, it depends on the use case.

### Traditional Single Page Applications - _3 / 5_
...
### Traditional Single Page Applications - _2 / 5_
...
### Traditional Single Page Applications - _5 / 5_
