...
import spacePirate from '../images/space-pirate.png';
...
const Home = () => {
  ...
  return (
    <Box
      fill='vertical'
      // style={GRADIENT}
      background={{ image: `url(${spacePirate})` }}
      // style={{ opacity: 0.6 }}
    ...
    >
      ...
      >
        ...
        >
            ...
            }
            {
              ((size === 'small' && !hasTerminal) || (size !== 'small')) && (
                <Heading
                  style={{
                    position: 'relative',
                    bottom: size === 'small' ? '0.4em' : 0,
                  }}
                  color='white'
                  margin='none' size='xlarge'
                >
                  UI / UX
                </Heading>
              )
          ...
          >
            <Heading color='white' margin='none' level={2}>DEVELOPER</Heading>
          </Box>
        </Box>
      </Box>
