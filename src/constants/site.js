...
export const aboutMe =
  "Although my background is in computer engineering, I'm fascinated by the challenges that " +
...
export default [
  {
    title: "Application",
    description:
      "This application was built with React and Grommet. I've got nothing but love for React. Excellent DOM abstraction, JSX, " +
  ...
  },
  {
    title: "Build",
    description:
      "Gatsby is categorized as a static site builder, but it is so much more. It completely abstracts away the bundler and " +
  ...
  },
  {
    title: "Deploy",
    description:
      "After any code is pushed to Github and merged to master, Netlify triggers a build and deploy through a managed CI/CD pipeline. " +
